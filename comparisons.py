# custom comparison classes based on Chatterbot comparisons
...
class CustomLevenshteinDistance(Comparator):
    """
...
class CustomSpacySimilarity(Comparator):
    """
...
class CustomJaccardSimilarity(Comparator):
    """
