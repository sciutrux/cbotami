# custom search algorithm based on Chatterbot IndexedTextSearch
# no actual changes currently though

from chatterbot.conversation import Statement

class CustomIndexedTextSearch:
    """
    ...
    name = 'custom_indexed_text_search'
